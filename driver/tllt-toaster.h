...
TlltToaster *tllt_toaster_new(const unsigned char top_elem_gpio_pin,
							  const unsigned char bottom_elem_gpio_pin,
							  const unsigned char scale_gpio_pin,
							  const unsigned char thermistor_gpio_pin);
